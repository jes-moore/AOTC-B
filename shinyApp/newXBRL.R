...
newxbrlDoAll <- function(file.inst, cache.dir="xbrl.Cache",
...
newXBRL <- function() {
        ...
        openInstance <- function(file.inst) {
                ...
                doc.inst <<- newxbrlParse(file.inst)
        }
